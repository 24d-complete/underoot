...
lw_1.lw.onConfigChange(['view.pdf.toolbar.hide.timeout', 'view.pdf.invert', 'view.pdf.invertMode', 'view.pdf.color', 'view.pdf.internal', 'view.pdf.reload.transition', 'view.pdf.supersampling'], () => {
    reload();
});
...
function getParams() {
    ...
    const pack = {
        ...
        supersampling: configuration.get('view.pdf.supersampling'),
        gpuRasterization: configuration.get('view.pdf.gpuRasterization'),
        lcdTextRendering: configuration.get('view.pdf.lcdTextRendering'),
    };
    return pack;
}
/**
